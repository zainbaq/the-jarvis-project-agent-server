      ...
      <div className="modal-content">
        ...
        <div className="modal-body">
          ...
          <p className="warning-text">
            You have <strong>{fileCount}</strong> file
            {fileCount !== 1 ? "s" : ""} uploaded in this conversation.
          </p>

          <p className="warning-subtext">
            Switching agents will start a new conversation, and your uploaded
            files will be lost. You'll need to upload them again with the new
            agent.
          </p>
        </div>
